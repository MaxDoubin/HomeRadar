# Contributing to HomeSentry

HomeSentry is open source (MIT) and built in public as part of the Congressional App
...
- HomeSentry must never require the family to put it inline (no bridging/routing). Any
