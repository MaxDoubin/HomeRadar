...
HomeSentry turns the former into a fix for the latter: plug it into your router and get
...
HomeSentry runs passively on your LAN — it never sits inline between your devices and the
